...
const data = extract(buffer, { palettes: false, spriteBuffer: false, decodeSpriteBuffer: true });

for (const sprite of data.sprites) {
  console.log(`Generating sprite, group ${sprite.group}, number ${sprite.number} ...`);
  saveAsPNG(sprite.decodedBuffer, sprite.width, sprite.height, `${__dirname}/sprites/${sprite.group}-${sprite.number}.png`);
}